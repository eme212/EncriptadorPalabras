function encriptar() {
    ...
    //defino variable donde voy a retornar el texto encriptado utilizando lo recibido en la variable encriptacion
    document.getElementById("devolucionTexto").innerHTML = encriptacion;
}
